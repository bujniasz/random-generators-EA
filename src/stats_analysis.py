...
for func in functions:
    ...
    # Folder dla danej funkcji
    func_dir = f"results_data/{func}"
    os.makedirs(func_dir, exist_ok=True)

    plot_dir = f"plots/{func}"
    ...
    plt.title(f"Rozkład wyników – {func}")
    ...
    plt.title(f"Rozkład wyników – {func} (bez lattice)")
    plt.xlabel("Generator")
    plt.ylabel("Najlepszy wynik")
    plt.yscale("log")
    ...
    plt.title(f"Czas działania vs wynik – {func}")
    ...
    plt.title(f"Czas działania vs wynik – {func} (bez lattice)")
    plt.xlabel("Czas działania (s)")
    plt.ylabel("Najlepszy wynik")
    plt.yscale("log")
    plt.tight_layout()
